...
class AnimatedBottomBar extends StatefulWidget{
  ...
  AnimatedBottomBar({this.barItems,this.animationDuration = const Duration(milliseconds: 500),this.onBarTab});
...
class _AnimatedBottomBarState extends State<AnimatedBottomBar> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Padding(
        padding: const EdgeInsets.only(bottom: 5.0,top: 5.0,left: 4.0,right: 4.0),
        child: Row(
      ...
      _barItems.add(
        InkWell(
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              children: <Widget>[
                Icon(item.iconData,color: isSelected ? item.color : Colors.black,size: 24.0,),
                Padding(
                ...
                AnimatedSize(
                  ...
                  style: TextStyle(color: isSelected ? item.color : Colors.black,fontWeight: FontWeight.w600,fontSize: 15)),
                )
              ],
            ),
          ),
